...
```
alex@DESKTOP-SBHASL4:~/homework/terraform02/02/src$ yc compute instance list
+----------------------+-------------------------------+---------------+---------+----------------+-------------+
|          ID          |             NAME              |    ZONE ID    | STATUS  |  EXTERNAL IP   | INTERNAL IP |
+----------------------+-------------------------------+---------------+---------+----------------+-------------+
| fhmm2qedock85a0uibpj | netology-develop-platform-web | ru-central1-a | RUNNING | 158.160.54.211 | 10.0.1.8    |
+----------------------+-------------------------------+---------------+---------+----------------+-------------+
```
- скриншот успешного подключения к консоли ВМ через ssh,
```
alex@DESKTOP-SBHASL4:~/homework/terraform02/02/src$ ssh -i ~/.ssh/id_rsa ubuntu@158.160.54.211
...
ubuntu@fhmm2qedock85a0uibpj:~$ exit
logout
Connection to 158.160.54.211 closed.
```
- ответы на вопросы.

###         При выполнении кода была ошибка по кол-ву ядер в создавайемой машине, т.к. мин. допустимое для данного типа сборки было "2". preemptible = true - сделать ВМ прерываемой, core_fraction - уровень производительности в процентах от макс.
...
```
alex@DESKTOP-SBHASL4:~/homework/terraform02/02/src$ terraform output
external_ip_address_platform2_yandex_cloud = "62.84.117.39"
external_ip_address_platform_yandex_cloud = "158.160.54.211"
alex@DESKTOP-SBHASL4:~/homework/terraform02/02/src$
```
